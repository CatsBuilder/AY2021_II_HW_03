...
CY_ISR(CustomTimerISR){
    ...
    for (i=0;i<NUMBER_OF_SAMPLES;i++)               // for 5 readings
    {
    ...
    ldr=ldr/NUMBER_OF_SAMPLES;                      // divide ldr by the number of samples to obtain the average 
    tmp=tmp/NUMBER_OF_SAMPLES;                      // divide tmp by the number of samples to obtain the average 
